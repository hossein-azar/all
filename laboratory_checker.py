...
def render_results(title, rooms_filtered, max_cap, out_csv_name, code_text):
    ...
    for r in ordered:
        ...
        legend_group_name = "✅ GOOD Laboratories" if status_ok else "❌ BAD Laboratories"
        
        # Room label text detailing description, number, and chair metrics
        full_label = f"{r.longname or 'Laboratory'} #{r.name} ({len(r.chairs)} chairs)"
        ...
        # Draw physical architectural outlines/borders using footprint
        ...
        for g in geoms:
            ...
            # Bottom profile outline wireframe
        ...
        # Room Matrix Center Text Floating Labels
